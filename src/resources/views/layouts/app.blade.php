        ...
        <div class="menu-items collapse navbar-collapse" style="margin-left: 75px">
            <ul class="navbar-nav nav ml-auto" style="font-style: normal; font-weight: 700; font-size: 15px; line-height: 22px;">
                <li class="nav-item" style="padding-right: 30px">
                    <a href="{{ route('mainPage.index') }}" class="nav-link active"><span>Domov</span></a>
                </li>
                <li class="nav-item" style="padding-right: 30px">
                    <a href="{{ route('erasmus.index') }}" class="nav-link"><span>Erasmus+</span></a>
                </li>
                <li class="nav-item" style="padding-right: 30px">
                    <a href="{{ route('anotherMobilities.index') }}" class="nav-link"><span>Iné mobility</span></a>
                </li>
                <li class="nav-item" style="padding-right: 30px">
                    <a href="{{ route('messages.index') }}" class="nav-link"><span>Správy účasníkov</span></a>
                </li>
                <li class="nav-item" style="padding-right: 30px">
